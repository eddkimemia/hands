    ...
    products: [
      {
        ...
        description:
          "Soft cotton tee with the Hands of Hope mark on the chest. Wear the mission — proceeds support community programs.",
        priceKes: 2500,
        image: IMG.shopTee,
        sizes: ["S", "M", "L", "XL", "XXL"],
        colors: ["Navy", "White"],
      ...
      },
      {
        ...
        name: "Warmth Hoodie",
        description:
          "Heavyweight fleece hoodie embroidered with the Hands of Hope sun mark. Warmth you wear; warmth you give.",
        priceKes: 4500,
      ...
      },
      {
        ...
        slug: "hope-cap",
        name: "Rise Cap",
        description: "Classic six-panel cap with the rising-sun emblem.",
        priceKes: 1500,
        image: IMG.shopCap,
        sizes: [],
        colors: ["Navy"],
      ...
      },
      {
        ...
        description: "Sturdy canvas tote printed with 'Extending Hands. Inspiring Hope.'",
        priceKes: 1200,
        image: IMG.shopTote,
        sizes: [],
        colors: ["Natural"],
      ...
      },
      {
        ...
        description: "500ml steel bottle celebrating our clean-water initiatives.",
        priceKes: 1000,
      ...
      },
      {
        ...
        slug: "supporter-pack",
        name: "Supporter Pack",
        description: "Tee + cap + tote bundled together — our best-value way to represent the mission.",
        priceKes: 4800,
